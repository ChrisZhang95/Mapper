...
SUITE(street_queries) {
    ...
    TEST(find_street_ids_from_name){
        ...
        expected = {2877};
        actual = find_street_ids_from_name("Earnscliffe Road");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {1743, 6320, 15734};
        ...
        expected = {2826, 9179,};
        actual = find_street_ids_from_name("Price Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {529, 585};
        actual = find_street_ids_from_name("Carlton Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {145};
        actual = find_street_ids_from_name("Riverdale Avenue");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {17081, 17082,};
        actual = find_street_ids_from_name("Eglinton Avenue");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {18641, 18642, 18702, 18964, 18965, 19489};
        actual = find_street_ids_from_name("Dundas Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = 200, 6260, 6533, 6798, 9962};
        actual = find_street_ids_from_name("Queen Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {4378, 6024, 8149, 8231};
        actual = find_street_ids_from_name("Kirby Road");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {11917};
        actual = find_street_ids_from_name("King Road");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {17133};
        actual = find_street_ids_from_name("Honey Drive");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {11873};
        actual = find_street_ids_from_name("Beacon Road");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {11872};
        actual = find_street_ids_from_name("Wickware Gate");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {10880};
        actual = find_street_ids_from_name("Flora Drive");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {5125};
        actual = find_street_ids_from_name("Lawrence Avenue");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {533, 10954};
        actual = find_street_ids_from_name("Nelson Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
        
        expected = {305};
        actual = find_street_ids_from_name("Brimley Road");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected, actual);
    }
