...
void handle_zoom_fit(float x, float y, void (*drawscreen) (void), bool);
void zoom_in(void (*drawscreen) (void));
void zoom_fit(void (*drawscreen)(void), float, float, bool);
...
public:
    ...
    static void updateinput(std::string);
...
//void drawtext(float xc, float yx, const )
